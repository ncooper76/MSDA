...
key <- "b74f5ed70f7242debda9650fd796a1ea"
```
...
nyt_mp <- nyt_url %>% GET(add_headers('api-key'=key)) # The key is in a hidden line of code.
nyt_mp <- nyt_mp %>% content(as='text') %>% fromJSON(simplifyDataFrame = TRUE) ## reading as text here turned out to be the easiest route since
