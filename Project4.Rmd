...
#Spam Cloud
wordcloud(spam, max.words = 100, random.order = FALSE, random.color = TRUE,colors=palette())
#Ham Cloud
wordcloud(ham, max.words = 100, random.order = FALSE, random.color = TRUE,colors=palette())
```
